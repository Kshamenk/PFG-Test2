<template>
  <div class="registration-form">
    ...
    <form @submit.prevent="registerUser">
      ...
      <input type="text" v-model="username" @input="validateUsername" @blur="focusField('username')" required
      ...
      <input type="email" v-model="email" @input="validateEmail" @blur="focusField('email')" required id="email"
      ...
      <input type="password" v-model="password" @input="validatePassword" @blur="focusField('password')" required
    ...
    <button type="submit" @click="goToRepository" :disabled="isButtonDisabled">
      Go to Repository
    </button>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    goToRepository() {
      ...
      window.location.href = 'https://github.com/Kshamenk/PFG-Test2';
      setTimeout(() => {
